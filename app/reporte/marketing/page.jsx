      ...
      <div style={{ padding: "20px 24px" }}>
        ...
        {!mostrarEmail ? (
          ...
          <div style={{ background: BLANCO, borderRadius: 14, padding: "20px", border: `1px solid ${GRIS_BORDE}`, marginBottom: 20 }}>
            ...
            <button onClick={async () => { if (email) { setEmailOk(true); try { await fetch("/api/guardar-email", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ email, reporte: "marketing" }) }); } catch (_) {} generarPDFMarketing(r); } }} disabled={!email}
